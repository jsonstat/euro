...
<script src="https://unpkg.com/jsonstat-euro@2.1.0"></script>
```

```html
<script src="https://cdn.jsdelivr.net/combine/npm/jsonstat-toolkit@1.4.2,npm/jsonstat-euro@2.1.0"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/combine/npm/es6-promise@4.2.8,npm/whatwg-fetch@3.0.0,npm/jsonstat-toolkit@1.4.2,npm/jsonstat-euro@2.1.0"></script>
```
...
```html
<script type="module">
import * as EuroJSONstat from "https://cdn.jsdelivr.net/npm/jsonstat-euro@2.1.0/import.mjs";
</script>
```

```html
<script type="module">
import * as EuroJSONstat from "https://unpkg.com/jsonstat-euro@2.1.0/import.mjs";
</script>
```
...
```js
EuroJSONstat = import("jsonstat-euro@2.1.0/import.mjs");
```
