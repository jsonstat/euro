...
<script src="https://unpkg.com/jsonstat-euro@3.0.0"></script>
```

```html
<script src="https://cdn.jsdelivr.net/combine/npm/jsonstat-toolkit@2.2.0,npm/jsonstat-euro@3.0.0"></script>
```
...
```html
<script type="module">
import * as EuroJSONstat from "https://cdn.jsdelivr.net/npm/jsonstat-euro@3.0.0/import.mjs";
</script>
```

```html
<script type="module">
import * as EuroJSONstat from "https://unpkg.com/jsonstat-euro@3.0.0/import.mjs";
</script>
```
...
```js
EuroJSONstat = import("jsonstat-euro@3.0.0/import.mjs");
```
